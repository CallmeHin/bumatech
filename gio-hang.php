...
<body>
    ...
    <!-- BEGIN CONTENT -->
    <div class="s-cart-1 ht-mrt30 ht-mrb30">
        <div class="container">
            <div class="c-headline-2 h1">
                <h1 class="c_name">Giỏ hàng của bạn</h1>
            ...
            <table class="s_table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-name text-left"><strong class="ht-hover"><a href="">Tên sản phẩm</a></strong></td>
            ...
            <div class="s_footer clearfix">
                <a href="san-pham.php" class="c-btn--primary c-btn--sm pull-left">Tiếp tục mua hàng</a>
                <a href="dat-hang.php" class="c-btn--secondary c-btn--sm pull-right">Đặt hàng</a>
            </div>
        </div>
    </div>
    <style type="text/css" media="screen">
        ...
        .s-cart-1 .td-quantity span {
            ...
            margin: 0 auto;
            text-align: center;
            background-color: #2585b9;
        }
        .s-cart-1 .td-quantity input {
            display: block;
            text-align: center;
            border: 1px solid #2585b9;
            margin: 0 auto;
            font-weight: bold;
            min-width: 1.667em;
            width: 1.667em;
