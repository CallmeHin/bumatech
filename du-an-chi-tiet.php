...
<body>
    ...
    <div class="p-detail-6">
        <div class="container">
            <div class="row">
                <div class="col-lg-6"> <!--545x445-->
                    <div class="b_thumb ht-ratio--75"><span class="ht-ratio__img"><img src="images/duan/du-an-1.png" alt=""></span></div>
                </div>

                <div class="col-lg-6">
                    <div class="p_box">
                        <h1 class="title">Dự án Khu đô thị sinh thái An Phú Long Garden</h1>
                        ...
                        <ul class="info">
                            ...
                            <li class="fa-user"><span>Chủ đầu tư:</span> Saigonhitech</li>
            ...
            <div class="p_detail ht-mrt30">
                <div class="ht-format-detail">
                    ...
                    <p style="text-align: center;">
                        <img src="images/duan/du-an-1.png" /><br />
